...
CREATE TABLE IF NOT EXISTS `18kdgold_product_anklets` (
  ...
  `t_display_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
(1, 7480, 9065, '2025-07-02 09:30:33');
...
(1, 'A', 'Basic', 500.00, 11, 600.00, 6100.00, 'Perfect for starting your gold savings', 'active', '2025-07-16 18:22:23', '2025-07-16 18:22:23'),
(2, 'B', 'Premium', 1000.00, 11, 1200.00, 12200.00, 'Best value for regular savings', 'active', '2025-07-16 18:22:23', '2025-07-16 18:22:23'),
(3, 'C', 'Elite', 2000.00, 11, 2400.00, 24400.00, 'Maximum benefits for serious investors', 'active', '2025-07-16 18:22:23', '2025-07-16 18:22:23'),
(4, 'D', 'Royal', 2500.00, 11, 3000.00, 30500.00, 'Premium plan with higher benefits', 'active', '2025-07-16 18:22:23', '2025-07-16 18:22:23'),
(5, 'E', 'Imperial', 5000.00, 11, 6000.00, 61000.00, 'For high-value gold investors', 'active', '2025-07-16 18:22:23', '2025-07-16 18:22:23'),
(6, 'F', 'Dynasty', 10000.00, 11, 12000.00, 122000.00, 'Ultimate gold investment plan', 'active', '2025-07-16 18:22:23', '2025-07-16 18:22:23');
...
CREATE TABLE IF NOT EXISTS `product_activity_log` (
  ...
  `activity_type` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'ADD',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `v_status` int NOT NULL,
  `v_by` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `v_on` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
