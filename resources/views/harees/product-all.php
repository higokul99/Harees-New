...
<!-- Add CSS for lazy loading and filters -->
<style>
.lazy-image {
    background: #f8f9fa;
    min-height: 180px;
...
<div class="w-full">
    <div class="page-container">
        ...
        <div class="main-content">
            <h1 class="page-title"><?php echo ucfirst($name ?? 'Products'); ?> Collections</h1>
                ...
                <?php if (!empty($allItems)): ?>
                    ...
                    <?php
                        foreach ($allItems as $row) {
                            ...
                            $product_weight = $row['net_weight'] ?? 0;
                            $product_id = $row['id'] ?? 0;
                            $product_code = $row['product_code'] ?? '';
                            $is_featured = isset($row['is_featured']) ? intval($row['is_featured']) : 0;
                            $product_image = $row['img2'] ?? '';
                            
                            // Check if this product is in wishlist
                            $wishlistKey = $table_name . '_' . $product_id;
                            $isInWishlist = isset($_SESSION['wishlist'][$wishlistKey]);
                    ?>
                       <a href="product-detail?id=<?php echo $product_id; ?>&product_code=<?php echo $product_code; ?>&table=<?php echo $table_name; ?>"
                          data-gender="<?php echo htmlspecialchars($product_gender); ?>" 
                          data-size="<?php echo htmlspecialchars($product_size); ?>" 
                          data-weight="<?php echo htmlspecialchars($product_weight); ?>"
                          data-price="<?php 
                          ...
                          ?>">
                            <div class="product-card">
                                ...
                                switch ($env ?? 'local') {
                                    ...
                                    case 'prod':
                                        $loc = "ims/internal/";
                                        $imagedetails = $loc . $product_image;
                                        break;
                                    default:
                                        $loc = "ims/internal/";
                                        $imagedetails = $loc . $product_image;
                                ...
                                <div class="lazy-image" 
                                     ...
                                     data-alt="<?php echo htmlspecialchars($product_name); ?>">
                                ...
                                <div class="product-info">
                                    ...
                                    if (!empty($product_code)) {
                                        $data = displayRate($conn, $product_code, $table_name); 
                                        $Product_Rate = $data[0] ?? 0;
                                    } else {
                                        $Product_Rate = 0;
                                    }
                                    ?>
                                    <p class="product-price">₹ <?php echo ceil($Product_Rate); ?></p>
    ...
    <div class="mobile-filter-bottom-sheet" id="mobileFilterSheet">
        ...
        <div class="bottom-sheet-footer">
            ...
            <button class="bottom-sheet-clear" id="closeBottomSheet">Close</button>
