...
<h5 class="mb-4" style="color: #f5d02a;">Last Updated On : <?php echo $UpdatedDate; ?></h5>
                            <form action="MasterController.php" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="18K1GM" class="form-control" value="<?php echo $TodayGold_18K; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" oninput="this.value = this.value.slice(0, 4)">
                                </div>
                                <!-- <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">1 Gram </label>
                                    <input type="number" name="22K1GM" class="form-control" value="<?php echo $TodayGold_22K; ?>" id="exampleInputEmail1" oninput="this.value = this.value.slice(0, 4)" aria-describedby="emailHelp">
                                </div>
                                <!-- <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">8 Gram </label>
