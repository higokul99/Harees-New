...
if (!empty($_GET['search'])) {
    ...
    $where[] = "(o.id LIKE '%$search%' OR o.product_code LIKE '%$search%' OR u.fullname LIKE '%$search%')";
}
...
<div class="container-fluid position-relative d-flex p-0">
    ...
    <style>
            ...
            .badge.blue { background-color: #06b6d4; }
                                ...
                                <?php else: ?>
                                    <?php foreach ($filteredOrders as $order): ?>
                                        <tr>
                                            ...
                                            <td><code class="product-code"><?php echo $order['product_code']; ?></code></td>
                                            <td>
