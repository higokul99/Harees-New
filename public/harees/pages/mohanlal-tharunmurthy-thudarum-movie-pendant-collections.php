...
<?php
        ...
        //New Way of including header at any directory level
        require_once(dirname(__DIR__) . 'paths.php'); // Adjust the path if needed
...
<!-- nav bar close -->
    ...
    <div class="p-5 mx-auto">
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
            ...
            <div class="flex flex-col items-center justify-center">
                <img class="w-[150px] object-cover rounded-full border-4 border-yellow-300 border-double"
                    src="assets/harees-jewellery-anklets.png" alt="Anklet" />
                <h1 class="mt-2 text-center">Anklet</h1>
            </div>
            <div class="flex flex-col items-center justify-center">
                <img class="w-[150px] object-cover rounded-full border-4 border-yellow-300 border-double"
...
<?php include(BASE_PATH . 'includes/footer.php');include(BASE_PATH . 'includes/footer.php'); ?>
